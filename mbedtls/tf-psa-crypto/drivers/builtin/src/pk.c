 ...
 */
int mbedtls_pk_sign_restartable(hybrid_t* hybrid, mbedtls_pk_context *ctx,
                                mbedtls_md_type_t md_alg,
                                const unsigned char *hash, size_t hash_len,
 ...
 * Make a signature
 */
int mbedtls_pk_sign(hybrid_t* hybrid, mbedtls_pk_context *ctx, mbedtls_md_type_t md_alg,
                    const unsigned char *hash, size_t hash_len,
                    unsigned char *sig, size_t sig_size, size_t *sig_len,
                    int (*f_rng)(void *, unsigned char *, size_t), void *p_rng)
{
    return mbedtls_pk_sign_restartable(hybrid, ctx, md_alg, hash, hash_len,
                                       sig, sig_size, sig_len,
                                       f_rng, p_rng, NULL);
}
 ...
 */
int mbedtls_pk_sign_ext(hybrid_t* hybrid, mbedtls_pk_type_t pk_type,
                        ...
                        void *p_rng)
{
    ...
    */
    ...
    if (pk_type != MBEDTLS_PK_RSASSA_PSS) {
        return mbedtls_pk_sign(hybrid, ctx, md_alg, hash, hash_len,
